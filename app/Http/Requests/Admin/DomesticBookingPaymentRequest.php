...
class DomesticBookingPaymentRequest extends FormRequest
{
    use AuthorizesByPermissions;

    protected function permissions(): array
    {
        return ['domestic_bookings.manage_payments'];
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'refunded_payment_id'   => ['nullable', 'ulid', 'exists:domestic_booking_payments,id'],
        ];
    }
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $v) {
            ...
            if (! $booking instanceof DomesticBooking) {
                return;
            }

            // تحقق من توافق cash_account_id مع طريقة الدفع.
            ...
            // Refunds reserving/consuming money: pending, approved, paid.

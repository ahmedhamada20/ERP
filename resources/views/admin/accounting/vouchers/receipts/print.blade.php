...
<head>
    <meta charset="UTF-8">
    <title>سند قبض {{ $voucher->number }}</title>
    ...
    <style>
        ...
        .doc-title {
            text-align: center;
            background: #f3f4f6; border: 2px solid #1f2937;
        ...
        .amount-box {
            ...
            border: 2px solid #92400e; border-radius: 10px;
            padding: 1.25rem; margin: 1.5rem 0; text-align: center;
        }
        .amount-box .label { font-size: .9rem; color: #78350f; }
        .amount-box .value { font-size: 2.4rem; font-weight: 800; color: #92400e; }
        .amount-box .words { color: #78350f; margin-top: .4rem; font-weight: 600; }
...
<div class="doc">
    ...
    <div class="meta">
        <div class="meta-item">
            <div class="meta-label">استلمنا من السيد/السيدة</div>
            <div class="meta-value">{{ $voucher->party_name }}</div>
        </div>
        <div class="meta-item">
            <div class="meta-label">إلى حساب</div>
            <div class="meta-value">{{ $voucher->cashAccount->name }}</div>
        </div>

        <div class="meta-item">
            <div class="meta-label">طريقة الاستلام / المرجع</div>

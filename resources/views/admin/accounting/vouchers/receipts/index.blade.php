...
@section('page_title', 'سندات القبض')
@section('page_subtitle', 'كل الأموال الواردة للشركة — تُسجّل تلقائياً في دفتر اليومية')

@section('content')
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        <h6 class="mb-0"><i class="bi bi-arrow-down-circle-fill text-success"></i> سندات القبض</h6>
        <div class="d-flex gap-2 flex-wrap">
            ...
            <a href="{{ route('admin.accounting.vouchers.receipts.create') }}" class="btn btn-sm btn-success">
                <i class="bi bi-plus-lg"></i> سند قبض جديد
            </a>
            @endcan
        </div>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="receiptsTable" class="table pretty-table" style="width:100%;">
                <thead>
                    <tr>
                        <th>رقم السند</th>
                        <th>التاريخ</th>
...
<script>
$(function () {
    const t = $('#receiptsTable').DataTable({
        processing: true, serverSide: true, responsive: true,
        order: [[1, 'desc']],
        language: { url: 'https://cdn.datatables.net/plug-ins/2.0.7/i18n/ar.json' },
        ajax: {
            url: '{{ route('admin.accounting.vouchers.receipts.data') }}',
            data: d => {
